...
# Calcular DEA CCR e BCC (orientação input) 
e_crs <- dea(inputs, outputs, RTS = "crs", ORIENTATION = "in")  # Modelo CCR
e_vrs <- dea(inputs, outputs, RTS = "vrs", ORIENTATION = "in")  # Modelo BCC
...
write_xlsx(tabela, "eficiencia_times.xlsx")
